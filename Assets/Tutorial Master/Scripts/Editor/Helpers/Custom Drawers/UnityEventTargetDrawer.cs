...
namespace HardCodeLab.TutorialMaster.EditorUI.Drawers
{
    ...
    public class UnityEventTargetDrawer : PropertyDrawer
    {
        ...
        private void ValidateSource(SerializedProperty property)
        {
            ...
            var source = property.FindPropertyRelative("_source").objectReferenceValue as GameObject;
        ...
        private void GetSelectedUnityEvent(SerializedProperty property)
        {
        ...
        private void GetUnityEvents(SerializedProperty property)
        {
            ...
            var obj = property.FindPropertyRelative("_source").objectReferenceValue as GameObject;
            if (obj == null)
                return;
