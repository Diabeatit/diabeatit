...
namespace HardCodeLab.TutorialMaster.EditorUI
{
    ...
    public abstract class ModuleConfigEditor
    {
        ...
        /// <summary>
        /// Base path which is used to located serialzied property of this Module Config.
        /// </summary>
        ...
        private void SettingsHeader()
        {
            ...
            EditorField.Field(Editor.serializedObject.FindProperty(BasePath + ".Module"), new GUIContent("GameObject"));
        }
    }
}