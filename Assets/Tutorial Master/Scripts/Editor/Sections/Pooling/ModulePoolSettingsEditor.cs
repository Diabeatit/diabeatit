...
namespace HardCodeLab.TutorialMaster.EditorUI
{
    ...
    public sealed class ModulePoolSettingsEditor<TModule> : Section
        where TModule : Module
    {
        private readonly string _basePropertyName;

        public ModulePoolSettingsEditor(ref TutorialMasterEditor editor, string title, string basePropertyName)
        ...
        private void EvaluateProperty(ref SerializedProperty property)
        {
            ...
            if (property.objectReferenceValue == null
                ...
                || ((GameObject)property.objectReferenceValue).GetComponent<TModule>() == null)
            {
