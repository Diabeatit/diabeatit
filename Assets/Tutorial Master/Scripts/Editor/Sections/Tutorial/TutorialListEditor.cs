...
namespace HardCodeLab.TutorialMaster.EditorUI
{
    public sealed class TutorialListEditor : Section
    {
        ...
        {
            Editor.RegisterUndo(string.Format("Select Tutorial - \"{0}\"", Editor.TutorialManager.Tutorials[index].Name));

            GUI.FocusControl(null);
            Editor.EditorData.SelectedTutorialIndex = Mathf.Clamp(index, 0, Editor.TutorialManager.Tutorials.Count - 1);
