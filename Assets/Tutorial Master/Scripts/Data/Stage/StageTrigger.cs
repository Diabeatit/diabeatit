...
namespace HardCodeLab.TutorialMaster
{
    ...
    {
        /// <summary>
        /// The amount of time to wait before listening for input
        /// </summary>
        public float InputActivationDelay;
        ...
        private bool EvaluateDelayTimer()
        {
            ...
            if (CurrentInputDelayTimer >= InputActivationDelay)
            {
                OnDelayEnd.Invoke();
                _isReady = true;
                return true;
