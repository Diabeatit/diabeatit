...
namespace HardCodeLab.TutorialMaster
{
    ...
    public abstract class PopupModule : Module
    {
        ...
        {
            if (NullChecker.IsNull(ConfirmationButton, "Unable to assign click events! Button Component has not been assigned.", this))
                return;
        ...
        {
            if (ConfirmationButton == null || AdditionalButtonClickEvent == null) return;
        ...
        protected void SetImage(Sprite image)
        {
            ...
            if (NullChecker.IsNull(PopupImage, "Unable to set an image. Image Component has not been assigned.", this))
                return;
        ...
        {
            if (ConfirmationButton == null) return;
