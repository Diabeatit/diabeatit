...
namespace HardCodeLab.TutorialMaster
{
    ...
    public class TutorialMasterManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Gets the current Id of a currently playing tutorial
        /// </summary>
        /// <value>
        ...
        public float TutorialProgress
        {
            get
            {
                ...
                float progress = (float)(ActiveTutorial.CurrentStageIndex + 1) / ActiveTutorial.Stages.Count;
                if (progress <= 0)
                    return 0;
        ...
        public void StartTutorial(int tutorialId = 0)
        {
            ...
            CurrentTutorialIndex = tutorialId;
        ...
        private void SetListeners()
        {
            ...
            ActiveStage.Modules.Popups.Where(x => x.Enabled)
                .ToList()
                .ForEach(x => x.Module.AssignButtonClickEvent(x.Settings.ButtonClickEvent,
                    NextStage,
                    StopTutorial));
        }
